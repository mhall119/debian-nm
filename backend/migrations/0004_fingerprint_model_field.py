...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.fpr'
        db.alter_column('person', 'fpr', self.gf('backend.models.FingerprintField')(max_length=40, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Person.fpr'
        db.alter_column('person', 'fpr', self.gf('backend.models.CharNullField')(unique=True, max_length=80, null=True))
